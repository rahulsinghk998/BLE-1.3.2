 ...
 *                                        - ioCC2545.h -
 *
 * Header file with definitions for the Texas Instruments CC2545 low-power System-on-Chip:
 * an 8051-based MCU with 2.4 GHz RF transceiver, and up to 32 kB FLASH.
 *
...
#define  I2C_VECTOR     VECT( 14, 0x73 )   /*  I2C Interrupt	                           */
...
/* Interrupt Flags                                                                  */
SFRBIT( TCON    ,  0x88, _TCON7, _TCON6, ADCIF, _TCON4, URX0IF, IT1, RFERRIF, IT0 )
...
SFR(  P0INP      , 0x8F  )   /*  Port Input Mode                                    */

/* Port 1                                                                           */
SFRBIT( P1      ,  0x90, _P1_7, P1_6, P1_5, P1_4, P1_3, P1_2, P1_1, P1_0 )
...
/* Interrupt Enable 0                                                               */
SFRBIT( IEN0    ,  0xA8, EA, _IEN06, STIE, ENCIE, _IEN03, URX0IE, ADCIE, RFERRIE )
...
/*  Interrupt Flags 5                                                               */
SFRBIT(  IRCON2 ,  0xE8, _IRCON27, _IRCON26, _IRCON25, WDTIF, P1IF, I2CIF, UTX0IF, P2IF )
...
/* FIFO and RF core RAM registers */
...
#define I2CCON          XREG( 0x6230 )   /* Old name for I2CCFG register (kept for backward compatibility) */
#define I2CSTAT         XREG( 0x6231 )
#define I2CSTA          XREG( 0x6231 )   /* Old name for I2CSTAT register (kept for backward compatibility) */
#define I2CDATA         XREG( 0x6232 )
#define I2CDAT          XREG( 0x6232 )   /* Old name for I2CDATA register (kept for backward compatibility) */
#define I2CADDR         XREG( 0x6233 )
#define I2CADR          XREG( 0x6233 )   /* Old name for I2CADDR register (kept for backward compatibility) */
...
#define X_P3   		XREG( 0x70B0 )   /*  Port 3. NOTE! Read-only access from XREG.			*/
...
#define X_DMA1CFGL  XREG( 0x70D2 )   /*  DMA Channel 1 Configuration Address Low Byte     */
#define X_DMA1CFGH  XREG( 0x70D3 )   /*  DMA Channel 1 Configuration Address High Byte    */
...
#define X_PPULL     XREG( 0x70F8 )   /*  Port pull-up/pull-down                             */
#define X_P3INP     XREG( 0x70FA )   /*  Port 3 Input Mode                                  */
#define X_PPRI      XREG( 0x70FB )   /*  Peripheral Priority Setup                          */
...
#define X_P3DIR     XREG( 0x70F9 )   /*  Port 2 Direction                                   */
